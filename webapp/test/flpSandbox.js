		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom MyInbox",
									"targetURL": "#xcopmyibxmyinbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"xcopmyibxmyinbox-display": {
								"semanticObject": "xcopmyibxmyinbox",
								"action": "display",
								"description": "Custom MyInbox",
								"title": "Custom MyInbox",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=xcop.myibx.myinbox",
									"url": sap.ui.require.toUrl("xcop/myibx/myinbox")
								}
							}
						}
					}
